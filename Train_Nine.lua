...
--
  ...
  local bird1 = display.newImage("bird.png",200,30)
  local bird2 = display.newImage("bird.png",300,30)
  local bird3 = display.newImage("bird.png",400,30)
  local bird4 = display.newImage("bird.png",500,30)
  local bird5 = display.newImage("bird.png",600,30)
  local bird6 = display.newImage("bird.png",700,30)
  local bird7 = display.newImage("bird.png",800,30)
  local bird8 = display.newImage("bird.png",900,30)
  local bird9 = display.newImage("bird.png",950,30)
...
--========================================================================================	
	...
	localGroup:insert(bird3)
	localGroup:insert(bird4)
	localGroup:insert(bird5)
	localGroup:insert(bird6)
	localGroup:insert(bird7)
	localGroup:insert(bird8)
	localGroup:insert(bird9)
...
--====================================================================	
    ...
    local function Speech(event)
     ...
     transition.to( TrainGroup, { time=4000, x=-5000, onComplete=timer.performWithDelay( 2500,Speech, 1 )})
